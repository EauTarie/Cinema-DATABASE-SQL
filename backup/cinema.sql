...
-- III. CREATION DES DONNEES
    ...
    -- Création des données MOVIE :
        -- Movie n°1 :
            INSERT INTO movie (id, nom, release_date, category) VALUES (1, 'Eau-céan Pacifique', '20/12/2022', 'Dr-EAU-le');
        -- Movie n°2
            INSERT INTO movie (id, nom, release_date, category) VALUES (2, 'Eau-céan Atlantique', '05/05/2022', 'Mel-eau-dramatique');
        -- Movie n°3 :
            INSERT INTO movie (id, nom, release_date, category) VALUES (3, 'Eau-céan Arctique', '01/01/2023', 'Mel-eau-dramatique');
        -- Movie n°4 :
